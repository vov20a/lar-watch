                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name='code'
                                        ...
                                        value="{{ old('code') }}" placeholder="Код" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name='base'
                                        class="form-control @error('base')  is-invalid @enderror" id="base"
                                        value="{{ old('base') }}" placeholder="Статус" pattern="^[01]?$" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name='symbol_left'
                                        class="form-control @error('symbol_left')  is-invalid @enderror"
                                        id="symbol_left" value="{{ old('symbol_left') }}" placeholder="Symbol_left">
                                ...
                                <div class="form-group ">
                                    ...
                                    <input type="text" name='symbol_right'
                                        class="form-control @error('symbol_right')  is-invalid @enderror"
                                        id="symbol_right" value="{{ old('symbol_right') }}" placeholder="Symbol_right">
                                    @error('symbol_right')
                                    <div class="alert-danger invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>

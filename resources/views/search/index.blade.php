...
@section('title', "Search with: $search ")
@section('content')
<!--start-breadcrumbs-->
    ...
    <div class="container">
        <div class="prdt-top">
            ...
            <div class="col-md-9 prdt-left">
                <h2>Search with: {{ $search }}</h2>
                <div class="product-one">
                    @foreach ($products as $item)
                    <div class="col-md-4 product-left p-left">
                        <div class="product-main simpleCart_shelfItem">
                            <a href="{{ route('products.single', ['slug' => $item->slug]) }}" class="mask"><img
                                    class="img-responsive zoom-img" src="{{ asset($item->getImage()) }}" alt="" /></a>
                ...
                <div class="" style="padding-left: 15px;">{{ $products->appends(['search' => $search])->links() }}</div>
            </div>
            @else
            <div class="col-md-9 prdt-left">
